...
class Login extends React.Component {
    constructor(props) {
        ...
        this.submit = (e) => {
            console.clear();
            e.preventDefault()
            let data = "email=" + this.email.value + "&pass=" + this.pass.value;
            e.preventDefault();
            var xhttp = new XMLHttpRequest();
            xhttp.open("POST", "http://localhost/PHP/login.php", true);
                                    ...
                                    Login with Twitter
                                        ...
                                        <form className="login100-form validate-form" >
                                            ...
                                            <div className="container-login100-form-btn">
                                                <button className="login100-form-btn" onClick={(e) => this.submit(e)}>
                                                    Login
                                </button>
                                            </div>
                                        </form>
